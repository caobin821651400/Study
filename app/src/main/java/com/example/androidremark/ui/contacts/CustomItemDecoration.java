...
import com.example.androidremark.utils.ColorUtil;
...
public class CustomItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawTitleBar(Canvas canvas, RecyclerView parent, View child, ContactBean bean, int position) {
        ...
        canvas.drawCircle(MyUtils.dp2px(mContext, 42.5f), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(bean.getIndexTag(), MyUtils.dp2px(mContext, 42.5f), bottom - dividerHeight / 3, mPaint);
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        canvas.drawCircle(MyUtils.dp2px(mContext, 42.5f), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(mBeans.get(position).getIndexTag(), MyUtils.dp2px(mContext, 42.5f), bottom - dividerHeight / 3, mPaint);
    }
