 ...
 * 水印基view
 */
abstract class WaterMarkView : ViewGroup, WaterMarkSticker, View.OnClickListener {
    ...
    private var mRemoveView: ImageView? = null//mAdjustView
    private var mMoveHelper: StickerMoveHelper? = null
    private var mStickerHelper: StickerHelper<WaterMarkView>? = null
