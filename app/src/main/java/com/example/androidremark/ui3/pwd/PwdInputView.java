package com.example.androidremark.ui3.pwd;
...
public class PwdInputView extends AppCompatEditText {
    ...
    private final static int DEFAULT_HEIGHT = dp2px(45);
     ...
     * 实心圆的半径
     */
    private float pwdRadius = dp2px(6);
     ...
     * 分割线的宽度  默认1dp
     */
    private float divideLineWidth = dp2px(1);
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        maxCount = typedArray.getInt(R.styleable.PwdInputView_pwd_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.PwdInputView_pwd_circleColor, circleColor);
        textSize = typedArray.getDimension(R.styleable.PwdInputView_pwd_textSize, textSize);
        bottomLineColor = typedArray.getColor(R.styleable.PwdInputView_pwd_bottomLineColor, bottomLineColor);
        pwdRadius = typedArray.getDimension(R.styleable.PwdInputView_pwd_pwdRadius, pwdRadius);

        divideLineWidth = typedArray.getDimension(R.styleable.PwdInputView_pwd_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PwdInputView_pwd_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PwdInputView_pwd_psdType, psdType);
        rectAngle = typedArray.getDimension(R.styleable.PwdInputView_pwd_rectAngle, rectAngle);
        isPwd = typedArray.getBoolean(R.styleable.PwdInputView_pwd_isPwd, isPwd);
        autoSize = typedArray.getBoolean(R.styleable.PwdInputView_pwd_autoSize, autoSize);
...
//    }
     ...
     * @return
     */
    public List<String> subStringToList(String str) {
